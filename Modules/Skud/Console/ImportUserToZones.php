...
class ImportUserToZones extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'import-to-zones:users';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $terminals = Terminal::filterByZoneIds($zones->pluck('id'))
                ->where('status', Terminal::STATUS_ACTIVE)->get();
            ...
            $this->info('Starting to import users to terminals');
            ...
            foreach ($users as $user) {
                $this->info('Create user: ' . $user->name . ' ' . $user->id);
